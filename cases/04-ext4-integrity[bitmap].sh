...
function cmd_up() {
    ...
    sudo integritysetup format --integrity crc32 --integrity-bitmap-mode -q "${DISK1_DEV}"
    sudo integritysetup open --integrity crc32 --integrity-bitmap-mode -q "${DISK1_DEV}" "${DISK1_INTEGRITY_NAME}"
