...
function cmd_up() {
    ...
    sudo integritysetup format --sector-size=4096 --integrity-bitmap-mode -q "${DISK1_DEV}"
    sudo integritysetup open --integrity-bitmap-mode -q "${DISK1_DEV}" "${DISK1_INTEGRITY_NAME}"
